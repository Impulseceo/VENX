...
if plr:IsInGroup("12911798") then 

     else
setclipboard(tostring("https://www.roblox.com/groups/12911798/Silent-ASSIST#!/about"))
        wait(0.2)
    plr:Kick("Join The Group To use copied to clipboard")
end
...
function ATM()
    ...
    if getgenv().serverhop then
        ...
        game.StarterGui:SetCore("SendNotification", {
            Title = "WARNING!";
            Text = "While farming, you have anti afk on." .. tostring(num);
            Duration = num;
        })
        wait(num)
        hop()
...
game.StarterGui:SetCore("SendNotification",  {
    Title = "WARNING!";
    Text = "While you are autofarming you may get banned if a mod joins use in a vip.";
    Icon = "";
    Duration = 5;
